...
Module Module1
    ...
    Private Declare Function HH_GetLibraryVersion Lib "hhlib64.dll" (ByVal vers As String) As Integer

    'extern int _stdcall HH_GetErrorString(char* errstring, int errcode);
    Private Declare Function HH_GetErrorString Lib "hhlib64.dll" (ByVal errstring As String, ByVal errcode As Integer) As Integer

    'extern int _stdcall HH_OpenDevice(int devidx, char* serial);
    Private Declare Function HH_OpenDevice Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal serial As String) As Integer

    'extern int _stdcall HH_CloseDevice(int devidx);
    Private Declare Function HH_CloseDevice Lib "hhlib64.dll" (ByVal devidx As Integer) As Integer

    'extern int _stdcall HH_Initialize(int devidx, int mode, int refsource);
    Private Declare Function HH_Initialize Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal mode As Integer, ByVal refsource As Integer) As Integer
    ...
    Private Declare Function HH_GetHardwareInfo Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal model As String, ByVal partno As String, ByVal version As String) As Integer

    'extern int _stdcall HH_GetSerialNumber(int devidx, char* serial);
    Private Declare Function HH_GetSerialNumber Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal serial As String) As Integer

    'extern int _stdcall HH_GetBaseResolution(int devidx, double* resolution, int* binsteps);
    Private Declare Function HH_GetBaseResolution Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef Resolution As Double, ByRef Binsteps As Integer) As Integer


    'extern int _stdcall HH_GetNumOfInputChannels(int devidx, int* nchannels);
    Private Declare Function HH_GetNumOfInputChannels Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef nchannels As Integer) As Integer

    'extern int _stdcall HH_GetNumOfModules(int devidx, int* nummod);
    Private Declare Function HH_GetNumOfModules Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef nummod As Integer) As Integer

    'extern int _stdcall HH_GetModuleInfo(int devidx, int modidx, int* modelcode, int* versioncode);
    Private Declare Function HH_GetModuleInfo Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef modidx As Integer, ByRef modelcode As Integer, ByRef versioncode As Integer) As Integer

    'extern int _stdcall HH_GetModuleIndex(int devidx, int channel, int* modidx);
    Private Declare Function HH_GetModuleIndex Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef channel As Integer, ByRef modidx As Integer) As Integer

    'extern int _stdcall HH_Calibrate(int devidx);
    Private Declare Function HH_Calibrate Lib "hhlib64.dll" (ByVal devidx As Integer) As Integer

    'extern int _stdcall HH_SetSyncDiv(int devidx, int div);
    Private Declare Function HH_SetSyncDiv Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal div As Integer) As Integer

    'extern int _stdcall HH_SetSyncCFD(int devidx, int level, int zerox);
    Private Declare Function HH_SetSyncCFD Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal level As Integer, ByVal zerox As Integer) As Integer

    'extern int _stdcall HH_SetSyncChannelOffset(int devidx, int value);
    Private Declare Function HH_SetSyncChannelOffset Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal value As Integer) As Integer

    'extern int _stdcall HH_SetInputCFD(int devidx, int channel, int level, int zerox);
    Private Declare Function HH_SetInputCFD Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal channel As Integer, ByVal level As Integer, ByVal zerox As Integer) As Integer

    'extern int _stdcall HH_SetInputChannelOffset(int devidx, int channel, int value);
    Private Declare Function HH_SetInputChannelOffset Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal channel As Integer, ByVal value As Integer) As Integer

    'extern int _stdcall HH_SetStopOverflow(int devidx, int stop_ovfl, unsigned int stopcount);
    Private Declare Function HH_SetStopOverflow Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal stop_ovfl As UInteger, ByVal stopcount As Integer) As Integer

    'extern int _stdcall HH_SetHistoLen(int devidx, int lencode, int* actuallen);
    Private Declare Function HH_SetHistoLen Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal Binning As Integer, ByRef actuallen As Integer) As Integer

    'extern int _stdcall HH_SetBinning(int devidx, int binning);
    Private Declare Function HH_SetBinning Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal Binning As Integer) As Integer

    'extern int _stdcall HH_SetOffset(int devidx, int offset);
    Private Declare Function HH_SetOffset Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal Offset As Integer) As Integer

    'extern int _stdcall HH_ClearHistMem(int devidx);
    Private Declare Function HH_ClearHistMem Lib "hhlib64.dll" (ByVal devidx As Integer) As Integer

    'extern int _stdcall HH_StartMeas(int devidx, int tacq);
    Private Declare Function HH_StartMeas Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal tacq As Integer) As Integer

    'extern int _stdcall HH_StopMeas(int devidx);
    Private Declare Function HH_StopMeas Lib "hhlib64.dll" (ByVal devidx As Integer) As Integer

    'extern int _stdcall HH_CTCStatus(int devidx, int* ctcstatus);
    Private Declare Function HH_CTCStatus Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef Ctcstatus As Integer) As Integer

    'extern int _stdcall HH_GetHistogram(int devidx, unsigned int *chcount, int channel, int clear);
    Private Declare Function HH_GetHistogram Lib "hhlib64.dll" (ByVal devidx As Integer, <[In](), Out()> ByVal chcount() As UInteger, ByVal channel As Integer, ByVal clear As Integer) As Integer

    'extern int _stdcall HH_GetResolution(int devidx, double* resolution);
    Private Declare Function HH_GetResolution Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef Resolution As Double) As Integer

    'extern int _stdcall HH_GetSyncRate(int devidx, int* syncrate);
    Private Declare Function HH_GetSyncRate Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef Syncrate As Integer) As Integer

    'extern int _stdcall HH_GetCountRate(int devidx, int channel, int* cntrate);
    Private Declare Function HH_GetCountRate Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal channel As Integer, ByRef cntrate As Integer) As Integer

    'extern int _stdcall HH_GetFlags(int devidx, int* flags);
    Private Declare Function HH_GetFlags Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef Flags As Integer) As Integer

    'extern int _stdcall HH_GetElapsedMeasTime(int devidx, double* elapsed);
    Private Declare Function HH_GetElapsedMeasTime Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef elapsed As Double) As Integer

    'extern int _stdcall HH_GetWarnings(int devidx, int* Warnings);
    Private Declare Function HH_GetWarnings Lib "hhlib64.dll" (ByVal devidx As Integer, ByRef Warnings As Integer) As Integer

    'extern int _stdcall HH_GetWarningsText(int devidx, char* text, int warnings);
    Private Declare Function HH_GetWarningsText Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal Warningstext As String, ByVal Warnings As Integer) As Integer


    'for TT modes only

    'extern int _stdcall HH_SetMarkerEdges(int devidx, int me1, int me2, int me3, int me4);
    Private Declare Function HH_TTSetMarkerEdges Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal me0 As Integer, ByVal me1 As Integer, ByVal me2 As Integer, ByVal me3 As Integer, ByVal me4 As Integer) As Integer

    'extern int _stdcall HH_SetMarkerEnable(int devidx, int en1, int en2, int en3, int en4);
    Private Declare Function HH_SetMarkerEnable Lib "hhlib64.dll" (ByVal devidx As Integer, ByVal en0 As Integer, ByVal en1 As Integer, ByVal en2 As Integer, ByVal en3 As Integer, ByVal en4 As Integer) As Integer
    ...
    Private Declare Function HH_ReadFiFo Lib "hhlib64.dll" (ByVal devidx As Integer, <[In](), Out()> ByVal buffer() As Int32, ByVal count As Integer, ByRef nactual As Integer) As Integer
    ...
    Public Sub Main()
        ...
        Dim buffer(TTREADMAX) As Int32
        Dim i As Integer
        Dim Blocksz As Integer
        ...
        FileOpen(1, "TTTRMODE.OUT", OpenMode.Binary)


        ConsolePrint("HydraHarp 400  HHLIB     TTTR mode demo" & vbCrLf)
        ...
        Do
            ...
            Retcode = HH_ReadFiFo(Dev(0), buffer, Blocksz, Nactual) 'may return less!
            If (Retcode < 0) Then
            ...
            If (Nactual > 0) Then
                For i = 0 To Nactual - 1        ' save data in buffer to binary file
                    FilePut(1, buffer(i))       ' doing this in a loop is terribly slow but VB
