...
var
  ...
  Mode               : LongInt = MODE_T2; // This demo is only for T3! Observe suitable Sync divider and Range!
...
begin
  ...
  begin // It is a regular photon record
    TrueTime := OflCorrection + TTTR_Data.TimeTag;
    GotPhotonT2(TrueTime, TTTR_Data.Channel + 1); // We encode the regular channels as 1..N
  end;
end;
